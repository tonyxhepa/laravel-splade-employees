...
${codeFrame}` : message);
    ...
    const Nt = vueExports.ref(0), ie = vueExports.ref(1), D = vueExports.ref({}), ae = vueExports.ref(0), Xt = vueExports.ref({}), nt = {}, Te = typeof window > "u";
    function vo(e, t, r) {
    ...
    const $i = vueExports.ref({}), Ei = (e) => $i.value[e], $o = (e) => Object.keys(Ei.value[e]).length > 0, Ti = vueExports.ref({}), Eo = (e) => Ti.value[e], xi = vueExports.ref({}), To = (e) => xi.value[e], it = vueExports.ref([]);
    function xo(e) {
      it.value.push(e);
    }
    const _o = vueExports.computed(() => mo(it.value));
    function Io(e) {
    ...
    const ce = {
      ...
      setup(e) {
        ...
        const r = vueExports.ref(), n = vueExports.ref([]), i = vueExports.ref(null), s = vueExports.ref(null), a = vueExports.ref(true), o = vueExports.inject("$spladeOptions") || {}, l = vueExports.computed(() => m.currentStack.value < 1 ? [] : {
          filter: "blur(4px)",
        ...
        return m.setOnHead((d) => {
          ...
          n.value[m.currentStack.value] && (a.value = false), n.value[m.currentStack.value] = { html: d, type: v }, vueExports.nextTick(() => {
            a.value = true;
          });
        }), m.setOnServerError(function(d) {
          i.value = d;
        }), m.init(t.initialHtml, t.initialDynamics, t.initialSpladeData), vueExports.onMounted(() => {
          if (m.isSsr)
            return;
        ...
        }), (d, v) => (vueExports.openBlock(), vueExports.createElementBlock("div", null, [
          vueExports.unref(m).isSsr ? (vueExports.openBlock(), vueExports.createBlock(ce, {
            key: `visit.${vueExports.unref(m).pageVisitId.value}`,
          ...
          (vueExports.openBlock(true), vueExports.createElementBlock(vueExports.Fragment, null, vueExports.renderList(vueExports.unref(m).currentStack.value, (f) => (vueExports.openBlock(), vueExports.createBlock(ce, {
            key: `modal.${f}`,
            type: n.value[f].type,
            html: n.value[f].html,
            stack: f,
            "on-top-of-stack": vueExports.unref(m).currentStack.value === f,
            animate: a.value,
            onClose: (g) => c(f)
          }, null, 8, ["type", "html", "stack", "on-top-of-stack", "animate", "onClose"]))), 128)),
          i.value ? (vueExports.openBlock(), vueExports.createBlock(Wo, {
            key: 2,
            html: i.value,
            onClose: u
    ...
    function hr({ props: e, attrs: t, slots: r, slot: n, name: i }) {
      ...
      if (n) {
        ...
        for (let [d, v] of Object.entries(n))
          typeof v == "boolean" && (p = true), v === true && h.push(d);
...
`)].join(`
`));
          let d = Bi((a = p.props) != null ? a : {}, l), v = vueExports.cloneVNode(p, d);
          for (let f in d)
    ...
    function Mi(e) {
      return e.flatMap((t) => t.type === vueExports.Fragment ? Mi(t.children) : [t]);
    }
    function Bi(...e) {
      if (e.length === 0)
        return {};
    ...
    function tn() {
      return vueExports.inject(Ui, null);
    }
    function Ql(e) {
      vueExports.provide(Ui, e);
    }
    ...
    function Dt(e, t, { sorted: r = true, relativeTo: n = null, skipElements: i = [] } = {}) {
      ...
      let l = (() => {
        ...
        if (t & 8)
          return o.length - 1;
        throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last");
      })(), c = t & 32 ? { preventScroll: true } : {}, p = 0, h = o.length, d;
      do {
        if (p >= h || p + h <= 0)
          return 0;
        let v = u + p;
    ...
    function uu(e, t, r = vueExports.computed(() => true)) {
      function n(s, a) {
    ...
    let mt = Object.assign(vueExports.defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: vueExports.ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
      let i = vueExports.ref(null);
      n({ el: i, $el: i });
      let s = vueExports.computed(() => _t(i)), a = vueExports.ref(false);
      vueExports.onMounted(() => a.value = true), vueExports.onUnmounted(() => a.value = false), mu({ ownerDocument: s }, vueExports.computed(() => a.value && !!(e.features & 16)));
      let o = vu({ ownerDocument: s, container: i, initialFocus: vueExports.computed(() => e.initialFocus) }, vueExports.computed(() => a.value && !!(e.features & 2)));
      gu({ ownerDocument: s, container: i, containers: e.containers, previousActiveElement: o }, vueExports.computed(() => a.value && !!(e.features & 8)));
      let l = fu();
      function u(d) {
        let v = N(i);
        v && ((f) => f())(() => {
      ...
      return () => {
        ...
        return vueExports.h(vueExports.Fragment, [!!(f & 4) && vueExports.h($r, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: u, features: Ut.Focusable }), Q({ ourProps: v, theirProps: { ...t, ...$ }, slot: d, attrs: t, slots: r, name: "FocusTrap" }), !!(f & 4) && vueExports.h($r, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: u, features: Ut.Focusable })]);
      };
    } }), { features: Ki }), We = [];
    pu(() => {
      function e(t) {
    ...
    function kn(e, t = vueExports.ref(true)) {
    ...
    function yu() {
      return vueExports.inject(Yi, false);
    }
    let Er = vueExports.defineComponent({ name: "ForcePortalRoot", props: { as: { type: [Object, String], default: "template" }, force: { type: Boolean, default: false } }, setup(e, { slots: t, attrs: r }) {
      return vueExports.provide(Yi, e.force), () => {
        let { force: n, ...i } = e;
    ...
    let Qi = vueExports.defineComponent({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(e, { slots: t, attrs: r }) {
      let n = vueExports.ref(null), i = vueExports.computed(() => _t(n)), s = yu(), a = vueExports.inject(Zi, null), o = vueExports.ref(s === true || a == null ? bu(n.value) : a.resolveTarget());
      return vueExports.watchEffect(() => {
        ...
        return vueExports.h(vueExports.Teleport, { to: o.value }, Q({ ourProps: l, theirProps: e, slot: {}, attrs: r, slots: t, name: "Portal" }));
      };
    } }), Zi = Symbol("PortalGroupContext"), wu = vueExports.defineComponent({ name: "PortalGroup", props: { as: { type: [Object, String], default: "template" }, target: { type: Object, default: null } }, setup(e, { attrs: t, slots: r }) {
    ...
    function Eu({ slot: e = vueExports.ref({}), name: t = "Description", props: r = {} } = {}) {
    ...
    vueExports.defineComponent({ name: "Description", props: { as: { type: [Object, String], default: "p" }, id: { type: String, default: () => `headlessui-description-${et()}` } }, setup(e, { attrs: t, slots: r }) {
      let n = $u();
      return vueExports.onMounted(() => vueExports.onUnmounted(n.register(e.id))), () => {
        let { name: i = "Description", slot: s = vueExports.ref({}), props: a = {} } = n, { id: o, ...l } = e, u = { ...Object.entries(a).reduce((c, [p, h]) => Object.assign(c, { [p]: vueExports.unref(h) }), {}), id: o };
    ...
    function qu(e, t, r) {
      let n = Tu(ze), i = vueExports.computed(() => {
      ...
      return vueExports.watch([e, t], ([s, a], [o], l) => {
        ...
        let u = false;
        l(() => {
          u || (ze.dispatch("POP", o ?? s, r), u = true);
        });
      }, { immediate: true }), i;
    }
    ...
    let Ft = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", rn = vueExports.defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: Ft }, initialFocus: { type: Object, default: null }, id: { type: String, default: () => `headlessui-dialog-${et()}` } }, emits: { close: (e) => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
      ...
      let o = vueExports.ref(0), l = tn(), u = vueExports.computed(() => e.open === Ft && l !== null ? (l.value & z.Open) === z.Open : e.open), c = vueExports.ref(null), p = vueExports.ref(null), h = vueExports.computed(() => _t(c));
      ...
      let d = vueExports.computed(() => a.value && u.value ? 0 : 1), v = vueExports.computed(() => d.value === 0), f = vueExports.computed(() => o.value > 1), g = vueExports.inject(xr, null) !== null, w = vueExports.computed(() => f.value ? "parent" : "leaf"), $ = vueExports.computed(() => l !== null ? (l.value & z.Closing) === z.Closing : false), A = vueExports.computed(() => g || $.value ? false : v.value), S = vueExports.computed(() => {
        var E, T, q;
        return (q = Array.from((T = (E = h.value) == null ? void 0 : E.querySelectorAll("body > *")) != null ? T : []).find((F) => F.id === "headlessui-portal-root" ? false : F.contains(N(p)) && F instanceof HTMLElement)) != null ? q : null;
      });
      kn(S, A);
      let O = vueExports.computed(() => f.value ? true : v.value), b = vueExports.computed(() => {
        var E, T, q;
      ...
      kn(b, O), Ou({ type: "Dialog", enabled: vueExports.computed(() => d.value === 0), element: c, onUpdate: (E, T) => {
        if (T === "Dialog")
          return pe(E, { [Tr.Add]: () => o.value += 1, [Tr.Remove]: () => o.value -= 1 });
      } });
      let x = Eu({ name: "DialogDescription", slot: vueExports.computed(() => ({ open: u.value })) }), P = vueExports.ref(null), _ = { titleId: P, panelRef: vueExports.ref(null), dialogState: d, setTitleId(E) {
        P.value !== E && (P.value = E);
      }, close() {
        t("close", false);
      } };
      ...
      let C = vueExports.computed(() => !(!v.value || f.value));
      uu(() => k(), (E, T) => {
        _.close(), vueExports.nextTick(() => T == null ? void 0 : T.focus());
      }, C);
      let B = vueExports.computed(() => !(f.value || d.value !== 0));
      ...
      let L = vueExports.computed(() => !($.value || d.value !== 0 || g));
      return qu(h, L, (E) => {
        var T;
        ...
        return vueExports.h(Er, { force: true }, () => [vueExports.h(Qi, () => vueExports.h(wu, { target: c.value }, () => vueExports.h(Er, { force: false }, () => vueExports.h(mt, { initialFocus: q, containers: k, features: v.value ? pe(w.value, { parent: mt.features.RestoreFocus, leaf: mt.features.All & ~mt.features.FocusLock }) : mt.features.None }, () => Q({ ourProps: ye, theirProps: F, slot: H, attrs: r, slots: n, visible: d.value === 0, features: Vt.RenderStrategy | Vt.Static, name: "Dialog" }))))), vueExports.h($r, { features: Ut.Hidden, ref: p })]);
      };
    } });
    vueExports.defineComponent({ name: "DialogOverlay", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-overlay-${et()}` } }, setup(e, { attrs: t, slots: r }) {
    ...
    vueExports.defineComponent({ name: "DialogBackdrop", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-backdrop-${et()}` } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
      ...
      return n({ el: s, $el: s }), vueExports.onMounted(() => {
        ...
        return vueExports.h(Er, { force: true }, () => vueExports.h(Qi, () => Q({ ourProps: l, theirProps: { ...t, ...o }, slot: { open: i.dialogState.value === 0 }, attrs: t, slots: r, name: "DialogBackdrop" })));
      };
    } });
    let nn = vueExports.defineComponent({ name: "DialogPanel", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-panel-${et()}` } }, setup(e, { attrs: t, slots: r, expose: n }) {
    ...
    vueExports.defineComponent({ name: "DialogTitle", props: { as: { type: [Object, String], default: "h2" }, id: { type: String, default: () => `headlessui-dialog-title-${et()}` } }, setup(e, { attrs: t, slots: r }) {
    ...
    let ns = Vt.RenderStrategy, ct = vueExports.defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
      ...
      if (!Ru() && Yl())
        return () => vueExports.h(dt, { ...e, onBeforeEnter: a, onAfterEnter: o, onBeforeLeave: l, onAfterLeave: u }, n);
      let c = vueExports.ref(null), p = vueExports.computed(() => e.unmount ? ke.Unmount : ke.Hidden);
      i({ el: c, $el: c });
      let { show: h, appear: d } = Du(), { register: v, unregister: f } = ju(), g = vueExports.ref(h.value ? "visible" : "hidden"), w = { value: true }, $ = et(), A = { value: false }, S = rs(() => {
        !A.value && g.value !== "hidden" && (g.value = "hidden", f($), u());
      });
      vueExports.onMounted(() => {
        let L = v($);
        vueExports.onUnmounted(L);
      }), vueExports.watchEffect(() => {
      ...
      function B(L) {
        ...
        !T || !(T instanceof HTMLElement) || E || (A.value = true, h.value && a(), h.value || l(), L(h.value ? Ln(T, O, b, x, P, (q) => {
      ...
      return vueExports.onMounted(() => {
        vueExports.watch([h], (L, E, T) => {
          B(T), w.value = false;
        }, { immediate: true });
      }), vueExports.provide(an, S), Ql(vueExports.computed(() => pe(g.value, { visible: z.Open, hidden: z.Closed }) | s.value)), () => {
        let { appear: L, show: E, enter: T, enterFrom: q, enterTo: F, entered: ye, leave: H, leaveFrom: ft, leaveTo: Pt, ...Ae } = e, tt = { ref: c }, Pe = { ...Ae, ...d.value && h.value && xt.isServer ? { class: vueExports.normalizeClass([r.class, Ae.class, ...O, ...b]) } : {} };
        return Q({ theirProps: Pe, ourProps: tt, slot: {}, slots: n, attrs: r, features: ns, visible: g.value === "visible", name: "TransitionChild" });
      };
    } }), Mu = ct, dt = vueExports.defineComponent({ inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n }) {
      let i = tn(), s = vueExports.computed(() => e.show === null && i !== null ? (i.value & z.Open) === z.Open : e.show);
      vueExports.watchEffect(() => {
      ...
      return vueExports.onMounted(() => {
        ...
        return Q({ ourProps: { ...p, as: "template" }, theirProps: {}, slot: {}, slots: { ...n, default: () => [vueExports.h(Mu, { onBeforeEnter: () => t("beforeEnter"), onAfterEnter: () => t("afterEnter"), onBeforeLeave: () => t("beforeLeave"), onAfterLeave: () => t("afterLeave"), ...r, ...p, ...c }, n.default)] }, attrs: {}, features: ns, visible: a.value === "visible", name: "Transition" });
      };
    } });
    const Bu = {
      props: {
    ...
    function rr(e, t, r) {
      var n, i, s, a, o, l, u = 0, c = false, p = false, h = true;
      if (typeof e != "function")
    ...
    function dc(e, t, r) {
      ...
      cn(s)) && (o = uc(t)), re(t) ? (l = at(t, true), l.x += t.clientLeft, l.y += t.clientTop) : s && (l.x = un(s))), {
    ...
    function dn(e, t) {
      t === void 0 && (t = {});
      var r = t, n = r.placement, i = n === void 0 ? e.placement : n, s = r.strategy, a = s === void 0 ? e.strategy : s, o = r.boundary, l = o === void 0 ? hc : o, u = r.rootBoundary, c = u === void 0 ? cs : u, p = r.elementContext, h = p === void 0 ? gt : p, d = r.altBoundary, v = d === void 0 ? false : d, f = r.padding, g = f === void 0 ? 0 : f, w = Mc(typeof g != "number" ? g : Bc(g, ar)), $ = h === gt ? mc : gt, A = e.rects.popper, S = e.elements[v ? $ : h], O = jc(Je(S) ? S : S.contextElement || Me(e.elements.popper), l, c, a), b = at(e.elements.reference), x = fs({
        reference: b,
        element: A,
        strategy: "absolute",
        placement: i
...
`, "We recommend using the popper element as a wrapper around an inner", "element that can have any CSS property transitioned for animations."].join(" "));
    ...
    function id(e) {
      var t = e.state, r = e.options, n = e.name, i = r.mainAxis, s = i === void 0 ? true : i, a = r.altAxis, o = a === void 0 ? false : a, l = r.boundary, u = r.rootBoundary, c = r.altBoundary, p = r.padding, h = r.tether, d = h === void 0 ? true : h, v = r.tetherOffset, f = v === void 0 ? 0 : v, g = dn(t, {
        boundary: l,
        rootBoundary: u,
        padding: p,
        altBoundary: c
    ...
    function cd(e) {
      ...
      if (!t.modifiersData[n]._skip) {
        for (var i = r.mainAxis, s = i === void 0 ? true : i, a = r.altAxis, o = a === void 0 ? true : a, l = r.fallbackPlacements, u = r.padding, c = r.boundary, p = r.rootBoundary, h = r.altBoundary, d = r.flipVariations, v = d === void 0 ? true : d, f = r.allowedAutoPlacements, g = t.options.placement, w = Oe(g), $ = w === g, A = l || ($ || !v ? [Mt(g)] : ud(g)), S = [g].concat(A).reduce(function(Pe, qe) {
    ...
    function hd(e, t, r, n, i, s) {
      ...
      return vueExports.openBlock(), vueExports.createBlock(a, {
        ...
        default: vueExports.withCtx(() => [
          ...
          vueExports.createElementVNode("div", pd, [
    ...
    function ms(e, t, r, n, i, s) {
      ...
      if (u && c)
        return u == t && c == e;
      var p = -1, h = true, d = r & qd ? new Wt() : void 0;
    ...
    function bf(e, t, r, n, i, s) {
      ...
      return h ? (s || (s = new $e()), af(e, t, r, n, i, s)) : false;
    }
...
`));
    ...
    function Zf(e, t, r, n, i, s) {
      return vueExports.openBlock(), vueExports.createElementBlock("div", Qf, [
        vueExports.renderSlot(e.$slots, "default")
      ], 512);
    }
    ...
    function mp(e, t, r, n, i, s) {
      return vueExports.openBlock(), vueExports.createElementBlock("div", hp, [
...
`));
    ...
    function _p(e, t, r, n, i, s) {
      return vueExports.openBlock(), vueExports.createElementBlock("div", xp, [
        vueExports.renderSlot(e.$slots, "default")
      ], 512);
    }
